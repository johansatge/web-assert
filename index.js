...
function outputDiff(diffActual, diffExpect) {
  ...
  diffActualNode.innerHTML = removeSvgWhitespaces(renderTerminalSvg(diffActual, {...termOptions, title: 'Diff on actual' }))
  diffExpectNode.innerHTML = removeSvgWhitespaces(renderTerminalSvg(diffExpect, {...termOptions, title: 'Diff on expected' }))
}
